...
export interface Task {
  id: string; title: string; prompt: string; status: TaskStatus; stage: string; createdAt: string; updatedAt: string
...
export interface Preview { target: string; roots: string[]; output: string; network: string }
